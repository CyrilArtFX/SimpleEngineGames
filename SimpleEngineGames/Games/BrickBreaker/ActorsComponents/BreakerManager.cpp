...
BreakerManager::BreakerManager(BreakerBall* ballP, BreakerPaddle* paddleP, BreakerGrid* gridP) : Actor(), ball(ballP), paddle(paddleP), grid(gridP)
{
	ResetGrid();
}
